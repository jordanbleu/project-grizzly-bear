...
namespace Assets.Source.Components.Camera
{
    ...
    public class CameraParallaxFollower : MonoBehaviour
    {
        [SerializeField]
        [Tooltip("Drag your camera or virtual camera here.")]
        ...
        [SerializeField]
        [Tooltip("If true, will hard lock to the current Y position.  Does not work when scrollVertical = true.")]
        private bool maintainYPosition = false;
